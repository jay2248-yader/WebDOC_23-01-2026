...
export default function DocumentActionBar({ onPrint }) {
    ...
    return (
        <div className="print:hidden flex items-center justify-between px-6 py-4 bg-white shadow-sm mb-4">
            ...
            <button onClick={onPrint || (() => window.print())} className="flex items-center gap-2 bg-[#0F75BC] text-white px-2 py-2 rounded-lg text-sm hover:bg-blue-700">
                <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
