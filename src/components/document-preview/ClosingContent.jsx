...
export default function ClosingContent({ remark, setRemark, selectedDetailId, storeSetRemark, interactive }) {
    return (
        <>
            <div className="flex items-start mt-6">
                ...
                {interactive ? (
                    ...
                    <span className="flex-1 ml-1 text-gray-800 whitespace-pre-wrap break-all">{remark}</span>
                )}
            </div>
